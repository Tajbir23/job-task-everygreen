  ...
  return (
    <div>
        ...
        <div className="grid md:grid-cols-2 gap-14 mx-10 my-16">
            <div>
              <img className="shadow-xl" src="https://everythinggreen.org/assets/google-0effc151.png" alt="Website 1" />
              <div className="mt-5">
            ...
            <div>
              <img className="shadow-xl" src="https://everythinggreen.org/assets/facebook-cdaf40bf.png" alt="Website 1" />
              <div className="mt-5">
            ...
            <div>
              <img className="shadow-xl" src="https://everythinggreen.org/assets/alphabet-2dd8e6ce.png" alt="Website 1" />
              <div className="mt-5">
            ...
            <div>
              <img className="shadow-xl" src="https://everythinggreen.org/assets/red-inc-e83de883.png" alt="Website 1" />
              <div className="mt-5">
